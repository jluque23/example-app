...
public class CustomerForm extends FormLayout {
    ...
    public CustomerForm(List<Company> companies, List<Status> statuses) {
    ...
    public static abstract class ContactFormEvent extends ComponentEvent<CustomerForm> {
        ...
        protected ContactFormEvent(CustomerForm source, Contact contact) {
            super(source, false);
    ...
    public static class SaveEvent extends ContactFormEvent {
        SaveEvent(CustomerForm source, Contact contact) {
            super(source, contact);
        }
    }

    public static class DeleteEvent extends ContactFormEvent {
        DeleteEvent(CustomerForm source, Contact contact) {
            super(source, contact);
        }
